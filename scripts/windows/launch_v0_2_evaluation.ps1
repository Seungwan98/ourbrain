...
$runner = 'D:\ourbrain\scripts\windows\run_v0_2_evaluation.ps1'
...
Write-Output (
    "Started $taskName. It will calibrate both models and evaluate the selected " +
    "model on held-out test once."
)
